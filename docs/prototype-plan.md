...
P0 foundation was integrated through [PR #25](https://github.com/npclown/vector-studio/pull/25) as `28181b7`. Its [final acceptance review](evidence/p0.6/20260909-final/README.md) remains tied to measured source `b524927`. The user approved the [P1 scene/camera and visual contracts](plans/p1-instanced-primitives.md) on 2026-09-09. On 2026-09-12 the user approved [D4 entry/exit separation](plans/p1-instanced-primitives.md#d4-approved-entryexit-separation): P1.0b private contract freeze precedes P1.1-P1.5, while [measurement readiness](plans/p1-measurement-contract.md) continues independently and still blocks P1.6, final P1 acceptance and P2 entry. All P1 thresholds and required evidence remain unchanged. P1.1-P1.4 are integrated. P1.5 is locally complete with [headed primitive, overlap, precision and latest-scene recovery evidence](evidence/p1.5-visual-review-2026-09-12.md). After its protected integration, the next dependency is P1.0m A09/A10 method resolution; P1.6/P1.7 remain blocked. P2-P5 remain roadmap scope without execution-ready plans.
