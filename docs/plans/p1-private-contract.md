...
| V04 | Ellipse at `(200.25,80.5)`, 80x40, green fill, white stroke width 0.5; variants rotations 0,15,45,90 degrees, reflection `[-1,0,0,1,0,0]`, nonuniform `[2,0,0,0.5,0,0]`, shear `[1,0,0.25,1,0,0]`, applied about local center `(40,20)` before placement: `T(200.25,80.5) * T(40,20) * variant * T(-40,-20)`, keeping the 90-degree fixture visible                                                                                                                                                                                                                             | P1.2/P1.3/P1.5 |
| V05 | Line `(0,0)` to `(40,0)`, at `(40.25,140.5)`, fill null, white stroke width 3. Butt contour local x `[0,40]`, y `[-1.5,1.5]`; test the same affine linear variants as V04 about line midpoint `(20,0)`, before placement `(40.25,140.5)`                                                                                                                                                                                                                                                                                                                                        | P1.2/P1.3/P1.5 |
